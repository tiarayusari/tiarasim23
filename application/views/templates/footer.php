...
<script src="<?= base_url('assets/adminlte/plugins/datatables-buttons/js/dataTables.bootstrap4.min.js')?>"></script>
<script src="<?= base_url('assets/adminlte/plugins/jszip/jszip.min.js')?>"></script>
<script src="<?= base_url('assets/adminlte/plugins/pdfmake/js/pdfmake.min.js')?>"></script>
...
<script>
 $(document).ready(function () {
    ...
    function uploadSummernoteImage(file) {
        ...
        $.ajax({
            url: '<?= base_url('index.php/pasien/upload_summernote_image'); ?>',
            type: 'POST',
            data: data,
            contentType: false,
            cache: false,
